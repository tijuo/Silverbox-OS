...
libos_init.a: $(SB_PREFIX)/lib/libos.a
	cp $(SB_PREFIX)/lib/libos.a ./libos_init.a
...
$(OUTPUT): $(OBJ) $(SB_PREFIX)/lib/libc.a libos_init.a
	$(CC) $(CFLAGS) -c -I $(SB_PREFIX)/include $(SRC)
	$(LD) $(OBJ) $(LDFLAGS) -L$(SB_PREFIX)/lib ./libos_init.a -lc -o $(OUTPUT)
