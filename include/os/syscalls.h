...
SYSCALL4_PACKED_B1(get_page_mappings_base, addr_t, virt, size_t, count, uint32_t,
                   addrSpace, struct PageMapping *, mappings, level)
SYSCALL4_PACKED_B1(set_page_mappings_base, addr_t, virt, size_t, count, uint32_t,
                   addrSpace, struct PageMapping *, mappings, level)
